      ...
      if (_update.type != 'core') {
        if (_update.configuration && _update.configuration.version == 'beta') {
          if (isset(_update.plugin) && isset(_update.plugin.changelog_beta) && _update.plugin.changelog_beta != '') {
            ...
            tr += '<a class="btn btn-xs btn-warning cursor" title="{{Changelog}} stable" target="_blank" href="' + _update.plugin.changelog + '"><i class="fas fa-book"></i><span class="hidden-1280"> {{Changelog}}</span></a> '
          } else {
